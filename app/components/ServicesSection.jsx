  ...
  return (
    <section className="text-white" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        <Image src="/images/logos/programador.png" width={500} height={500} />
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          <h2 className="text-4xl font-bold text-white mb-4">Serviços Prestados</h2>
          <p className="text-base lg:text-lg">
            Verifique meus serviços disponíveis abaixo,
          ...
          <div className="flex flex-row justify-start mt-8">
            ...
            <TabButton
              selectTab={() => handleTabChange("consultorias")}
              active={tab === "consultorias"}
            >
              {" "}
              Consultorias{" "}
            </TabButton>
